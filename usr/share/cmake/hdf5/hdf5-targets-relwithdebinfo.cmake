...
# Import target "hdf5::hdf5" for configuration "RelWithDebInfo"
set_property(TARGET hdf5::hdf5 APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(hdf5::hdf5 PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5.so.10.3.2"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5.so.10"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5::hdf5 )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5::hdf5 "${_IMPORT_PREFIX}/lib/libhdf5.so.10.3.2" )
...
# Import target "hdf5::hdf5_tools" for configuration "RelWithDebInfo"
set_property(TARGET hdf5::hdf5_tools APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(hdf5::hdf5_tools PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_tools.so.10.0.7"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_tools.so.10"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5::hdf5_tools )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5::hdf5_tools "${_IMPORT_PREFIX}/lib/libhdf5_tools.so.10.0.7" )
...
# Import target "hdf5::h5repart_test" for configuration "RelWithDebInfo"
set_property(TARGET hdf5::h5repart_test APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(hdf5::h5repart_test PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/h5repart_test"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5::h5repart_test )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5::h5repart_test "${_IMPORT_PREFIX}/bin/h5repart_test" )
...
# Import target "hdf5::hdf5_hl" for configuration "RelWithDebInfo"
set_property(TARGET hdf5::hdf5_hl APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(hdf5::hdf5_hl PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_hl.so.10.2.2"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_hl.so.10"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5::hdf5_hl )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5::hdf5_hl "${_IMPORT_PREFIX}/lib/libhdf5_hl.so.10.2.2" )
...
# Import target "hdf5::hdf5_cpp" for configuration "RelWithDebInfo"
set_property(TARGET hdf5::hdf5_cpp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(hdf5::hdf5_cpp PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_cpp.so.16.0.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_cpp.so.16"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5::hdf5_cpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5::hdf5_cpp "${_IMPORT_PREFIX}/lib/libhdf5_cpp.so.16.0.0" )
...
# Import target "hdf5::hdf5_hl_cpp" for configuration "RelWithDebInfo"
set_property(TARGET hdf5::hdf5_hl_cpp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(hdf5::hdf5_hl_cpp PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libhdf5_hl_cpp.so.11.1.2"
  IMPORTED_SONAME_RELWITHDEBINFO "libhdf5_hl_cpp.so.11"
  )

list(APPEND _IMPORT_CHECK_TARGETS hdf5::hdf5_hl_cpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_hdf5::hdf5_hl_cpp "${_IMPORT_PREFIX}/lib/libhdf5_hl_cpp.so.11.1.2" )
