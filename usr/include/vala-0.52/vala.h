...
void vala_block_set_contains_jump_statement (ValaBlock* self,
                                             gboolean value);
gboolean vala_block_get_unreachable_exit (ValaBlock* self);
void vala_block_set_unreachable_exit (ValaBlock* self,
                                      gboolean value);
...
GType vala_callable_expression_get_type (void) G_GNUC_CONST ;
gboolean vala_callable_expression_get_is_yield_expression (ValaCallableExpression* self);
void vala_callable_expression_set_is_yield_expression (ValaCallableExpression* self,
                                                       gboolean value);
void vala_callable_expression_add_argument (ValaCallableExpression* self,
                                            ValaExpression* arg);
ValaList* vala_callable_expression_get_argument_list (ValaCallableExpression* self);
...
gboolean vala_class_get_is_opaque (ValaClass* self);
...
gboolean vala_code_context_is_defined (ValaCodeContext* self,
                                       const gchar* define);
void vala_code_context_set_target_profile (ValaCodeContext* self,
                                           ValaProfile profile,
...
GType vala_loop_statement_get_type (void) G_GNUC_CONST ;
...
GType vala_with_statement_get_type (void) G_GNUC_CONST ;
...
void vala_code_visitor_visit_loop_statement (ValaCodeVisitor* self,
...
void vala_code_visitor_visit_with_statement (ValaCodeVisitor* self,
...
ValaSymbol* vala_data_type_get_context_symbol (ValaDataType* self);
void vala_data_type_set_context_symbol (ValaDataType* self,
                                        ValaSymbol* value);
...
ValaDestructor* vala_destructor_construct (GType object_type,
                                           ValaSourceReference* source_reference);
ValaDoStatement* vala_do_statement_new (ValaExpression* condition,
                                        ValaBlock* body,
                                        ValaSourceReference* source_reference);
...
gboolean vala_expression_is_accessible (ValaExpression* self,
                                        ValaSymbol* sym);
gboolean vala_expression_is_always_true (ValaExpression* self);
gboolean vala_expression_is_always_false (ValaExpression* self);
...
GType vala_invalid_expression_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ValaInvalidExpression, vala_code_node_unref)
ValaInvalidExpression* vala_invalid_expression_new (void);
ValaInvalidExpression* vala_invalid_expression_construct (GType object_type);
...
ValaLockStatement* vala_lock_statement_construct (GType object_type,
                                                  ...
                                                  ValaBlock* body,
                                                  ValaSourceReference* source_reference);
ValaExpression* vala_loop_get_condition (ValaLoop* self);
ValaBlock* vala_loop_get_body (ValaLoop* self);
ValaLoop* vala_loop_construct (GType object_type,
                               ValaExpression* condition,
                               ValaBlock* body,
                               ValaSourceReference* source_reference);
ValaLoopStatement* vala_loop_statement_new (ValaBlock* body,
                                            ValaSourceReference* source_reference);
ValaLoopStatement* vala_loop_statement_construct (GType object_type,
                                                  ValaBlock* body,
                                                  ValaSourceReference* source_reference);
...
#define VALA_MINOR_VERSION 52
#define VALA_MICRO_VERSION 5
#define VALA_API_VERSION "0.52"
#define VALA_BUILD_VERSION "0.52.5"
...
ValaWhileStatement* vala_while_statement_construct (GType object_type,
                                                    ...
                                                    ValaBlock* body,
                                                    ValaSourceReference* source_reference);
ValaExpression* vala_with_statement_get_expression (ValaWithStatement* self);
ValaLocalVariable* vala_with_statement_get_with_variable (ValaWithStatement* self);
ValaBlock* vala_with_statement_get_body (ValaWithStatement* self);
ValaWithStatement* vala_with_statement_new (ValaLocalVariable* variable,
                                            ValaExpression* expression,
                                            ValaBlock* body,
                                            ValaSourceReference* source_reference);
ValaWithStatement* vala_with_statement_construct (GType object_type,
